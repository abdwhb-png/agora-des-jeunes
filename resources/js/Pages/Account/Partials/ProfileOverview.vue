...
<style>
.hero-bg {
    background-image: url("/static/media/images/2600x1200/bg-1.png");
}
.dark .hero-bg {
    background-image: url("/static/media/images/2600x1200/bg-1-dark.png");
}
</style>
    ...
    <div class="bg-center bg-cover bg-no-repeat hero-bg">
        ...
        >
            ...
            <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
                ...
                >
                    <i class="ki-filled ki-briefcase text-gray-500 text-sm">
                    </i>
