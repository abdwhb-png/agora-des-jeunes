<template>
    ...
    >
        ...
        >
            <span class="menu-title text-nowrap"> Besoin d'aide ? </span>
        ...
        <div
            class="menu-dropdown menu-default py-2.5 w-full max-w-[220px]"
            style=""
        >
            <div class="menu-item">
                <a class="menu-link" href="#" tabindex="0">
                    ...
                    <span class="menu-title grow-0"> Par où commencer </span>
                </a>
            </div>
            <div class="menu-item">
