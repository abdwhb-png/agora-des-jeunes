<template>
    <MainLayout title="Activités du compte">
        <div class="grid gap-5 lg:gap-7.5">
            <div class="flex gap-5 lg:gap-7.5">
                        ...
                        <div class="flex items-center gap-2">
                            <label class="switch">
                                <span class="switch-label">
                                    Auto refresh:
                                    <span class="switch-on:hidden"> Off </span>
                    ...
                    <div class="card-body">
                        <div class="flex flex-col">
                                    ...
                                    <div class="flex flex-col">
                                        <div class="text-sm text-gray-800">
                                            ...
                                            <a
                                                ...
                                                href="/metronic/tailwind/demo4/public-profile/profiles/blogger"
                                            >
                                                Top 10 Tech Trends
                                            </a>
                                        </div>
                            ...
                            <div class="flex items-start relative">
                                ...
                                >
                                    <i
                                        class="ki-filled ki-entrance-left text-base"
                                    >
                                    </i>
                                </div>
                                <div class="ps-2.5 mb-7 text-md grow">
                            ...
                            <div class="flex items-start relative">
                                ...
                                <div
                                    class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-300 size-9 text-gray-600"
                                >
                                    <i class="ki-filled ki-code text-base"> </i>
                                </div>
                                <div class="ps-2.5 mb-7 text-md grow">
                                    <div class="flex flex-col pb-2.5">
                                        <span class="text-sm text-gray-800">
                                            Jenny attended a Nature Photography
                                            Immersion workshop
                                        </span>
                                        <span class="text-xs text-gray-600">
                                            3 days ago, 11:45 AM
                                    ...
                                    <div class="card shadow-none">
                                        <div class="card-body">
                                            <div class="grid gap-4">
                                                ...
                                                >
                                                    <div
                                                        class="flex items-center gap-5 shrink-0"
                                                    >
                                                        <div
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <span
                                                                    class="text-2sm text-brand font-medium p-2"
                                                                >
                                                                    Apr
                                                                </span>
                                                            </div>
                                                            ...
                                                            >
                                                                <span
                                                                    class="font-medium text-gray-800 text-1.5xl tracking-tight"
                                                                >
                                                                    02
                                                                </span>
                                                            </div>
                                                        ...
                                                        <img
                                                            alt=""
                                                            class="rounded-lg max-h-20 max-w-full"
                                                    ...
                                                    >
                                                        <a
                                                            class="text-xs text-brand leading-[14px] hover:text-primary-active mb-px"
                                                            href="#"
                                                        >
                                                            Photo Workshop
                                                        </a>
                                                        <a
                                                            class="text-md font-medium hover:text-primary text-gray-900 leading-4"
                                                            href="#"
                                                        >
                                                            Nature Photography
                                                            Immersion
                                                        ...
                                                        <p
                                                            class="text-xs text-gray-800 leading-[22px]"
                                                        >
                                                            Enhance your nature
                                                            photography skills
                                                            in a hands-on
                            ...
                            <div class="flex items-start relative">
                                ...
                                <div class="ps-2.5 mb-7 text-md grow">
                                    <div class="flex flex-col">
                                        <div class="text-sm text-gray-800">
                                            I couldn't resist sharing a sneak
                                            peek of our
                                            <a
                                                class="text-sm link"
                                                href="/metronic/tailwind/demo4/public-profile/profiles/blogger"
                            ...
                            <div class="flex items-start relative">
                                ...
                                >
                                    <i
                                        class="ki-filled ki-calendar-tick text-base"
                                    >
                                    </i>
                                </div>
                                <div class="ps-2.5 mb-7 text-md grow">
                                    <div class="flex flex-col pb-2.5">
                                        <span class="text-sm text-gray-800">
                                            Jenny attended a webinar on new
                                            product features.
                                        </span>
                                        <span class="text-xs text-gray-600">
                                            3 days ago, 11:45 AM
                                    ...
                                    <div class="card shadow-none p-4">
                                        <div class="flex flex-wrap gap-2.5">
                                            <i
                                                class="ki-filled ki-code text-lg text-info"
                                            >
                                            </i>
                                            <div
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <span
                                                            class="text-md font-medium text-gray-900 cursor-pointer hover:text-primary mb-px"
                                                        >
                                                            Leadership
                                                            Development Series:
                                                            Part 1
                                                    ...
                                                    <a
                                                        class="btn btn-link"
                                                        href="/metronic/tailwind/demo4/account/members/teams"
                                                    >
                                                        View
                                                    </a>
                                                </div>
                                                <div
                                                    class="flex flex-wrap gap-7.5"
                                                >
                                                    <div
                                                        class="flex items-center gap-1.5"
                                                    >
                                                        <span
                                                            class="text-2sm font-medium text-gray-600"
                                                        >
                                                            Code:
                                                        </span>
                                                        <a
                                                            class="text-2sm text-primary"
                                                            href="#"
                                                        >
                                                            #leaderdev-1
                                                        </a>
                                                    ...
                                                    >
                                                        <span
                                                            class="text-2sm text-gray-600"
                                                        >
                                                            Progress:
                                                        </span>
                                                        <div
                                                            class="progress progress-success min-w-[120px]"
                                                        >
                                                            <div
                                                                class="progress-bar"
                                                                style="
                                ...
                                <div class="ps-2.5 mb-7 text-md grow">
                                    <div class="flex flex-col">
                                        <div class="text-sm text-gray-900">
                                            ...
                                            <a
                                                class="text-sm font-medium link"
                                                href="/metronic/tailwind/demo4/public-profile/profiles/feeds"
                                            >
                                                10,000 followers
                                            </a>
                            ...
                            <div class="flex items-start relative">
                                ...
                                >
                                    <i
                                        class="ki-filled ki-directbox-default text-base"
                                    >
                                    </i>
                                </div>
                                <div class="ps-2.5 mb-7 text-md grow">
                                    <div class="flex flex-col pb-2.5">
                                        <span class="text-sm text-gray-800">
                                            Attending the virtual blogging
                                        ...
                                        <div class="card-body lg:py-4">
                                            ...
                                            >
                                                <img
                                                    ...
                                                    src="/static/metronic/tailwind/dist/assets/media/illustrations/28.svg"
                                                />
                                                <img
                                                    alt="image"
                                                    class="light:hidden max-h-[160px]"
                                                    src="/static/metronic/tailwind/dist/assets/media/illustrations/28-dark.svg"
                                                />
                                            </div>
                                            <div class="flex flex-col gap-1">
                                                <div
                                                    class="text-md font-medium text-gray-900 text-center"
                                                >
                                                    Blogging Conference
                                                </div>
                                                <div
                                                ...
                                                >
                                                    <a
                                                        class="text-2sm font-semibold link"
                                                        href="/metronic/tailwind/demo4/public-profile/profiles/company"
                                                    >
                                                        Axio new release
                                                    </a>
                                                    <span
                                                        class="text-2sm text-gray-700 me-2"
                                                    >
                                                        email campaign
                                                    </span>
                                                    <span
                            ...
                            <div class="flex items-start relative">
                                ...
                                <div class="ps-2.5 mb-7 text-md grow">
                                    <div class="flex flex-col">
                                        <div class="text-sm text-gray-800">
                                            Onboarded a talented designer to our
                                            creative team, adding valuable
                                    ...
                                    <div class="grow">
                                        <div class="flex flex-col pb-2.5">
                                            <div class="text-sm text-gray-800">
                                                A new team
                                                <a
                                                    class="text-sm font-medium text-gray-900 hover:text-primary-active"
                                                    href="#"
                                                >
                                                    Market Mavericks
                                                </a>
                                        ...
                                        <div class="card shadow-none p-4">
                                            <div
                                                class="flex flex-wrap justify-between items-center gap-7"
                                            >
                                                <div
                                                    class="flex items-center gap-4"
                                                >
                                                    <div
                                                        class="relative size-[50px] shrink-0"
                                                    >
                                                        <svg
                                                            class="w-full h-full stroke-primary-clarity fill-primary-light"
                                                            fill="none"
                                                            height="48"
                                                            viewBox="0 0 44 48"
                                                            width="44"
              ...
              39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z"
                                                    ...
                                                    >
                                                        <a
                                                            class="text-base font-medium hover:text-primary text-gray-900"
                                                            href="#"
                                                        >
                                                            Market Mavericks
                                                        </a>
                                                        <p
                                                            class="text-2sm text-gray-700"
                                                        >
                                                            Navigating markets
                                                            with strategic
                                                            solutions
                                                ...
                                                <div
                                                    class="flex flex-wrap items-center gap-6 lg:gap-12"
                                                >
                                                    <div
                                                        class="flex flex-col items-end gap-5"
                                                    >
                                                        <span
                                                            class="text-2xs text-gray-600 uppercase"
                                                        >
                                                            rating
                                                        </span>
                                                        <div class="rating">
                                                            <div
                                                                class="rating-label checked"
                                                            >
                                                                <i
                                                            ...
                                                            <div
                                                                class="rating-label indeterminate"
                                                            >
                                                                <i
                                                                    class="rating-on ki-solid ki-star text-base leading-none"
                                                                    style="
                                                    ...
                                                    <div
                                                        class="grid justify-end min-w-20"
                                                    >
                                                        <a
                                                            class="btn btn-sm btn-primary"
                                                        >
                                                            <i
                                                                class="ki-filled ki-people"
                                                            >
                                                            </i>
                                                            Join
                                                        </a>
                            ...
                            <div class="flex items-start relative">
                                ...
                                >
                                    <i
                                        class="ki-filled ki-like-shapes text-base"
                                    >
                                    </i>
                                </div>
                                <div class="ps-2.5 mb-7 text-md grow">
                                    <div class="flex flex-col">
                                        ...
                                        >
                                            ...
                                            <a
                                                class="text-sm font-medium link"
                                                href="/metronic/tailwind/demo4/public-profile/profiles/creator"
                                            >
                                                team-building event
                                            </a>
                                            , fostering collaboration and
                                            strengthening bonds among team
                                            members.
                                        </div>
                                        <span
                            ...
                            <div class="flex items-start relative">
                                <div
                                    class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-300 size-9 text-gray-600"
                                >
                                    <i class="ki-filled ki-cup text-base"> </i>
                                </div>
                                <div class="ps-2.5 text-md grow">
                                    <div class="flex flex-col">
                                        <div class="text-sm text-gray-800">
                                            ...
                                            <a
                                                class="text-sm font-medium link"
                                                href="/metronic/tailwind/demo4/public-profile/profiles/nft"
                                            >
                                                celebrated
                                            </a>
                    ...
                    <div class="card-footer justify-center">
                        <a class="btn btn-link" href="#"> All-time Activity </a>
                    </div>
                </div>
              ...
              39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z"
                ...
                <div class="flex flex-col gap-2.5" data-tabs="true">
                    <a
                        class="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary active"
                    ...
                    <a
                        class="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary"
