<template>
    <form @submit.prevent="submit">
        ...
        <FloatLabel variant="on" class="mb-4">
            ...
            <label for="description">Description du role (facultatif)</label>
...
const submit = () => {
    const url = props.item
        ? route(page.props.routePrefix + "role.update", props.item.id)
        : route(page.props.routePrefix + "role.store");
